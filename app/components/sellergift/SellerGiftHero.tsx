...
export default function SellerGiftHero() {
  ...
  return (
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-40 right-1/4 w-96 h-96 bg-green-200 rounded-full opacity-20 blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-100 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-sm font-medium text-emerald-700">{t.sellergift.hero.badge}</span>
          </div>
          ...
          <h1 className="font-[family-name:var(--font-montserrat)] text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold text-gray-900 leading-[1.1]">
            {t.sellergift.hero.headingLine1}{" "}
            <span className="gradient-text">{t.sellergift.hero.headingHighlight}</span>
          </h1>

          <p className="mt-6 text-lg text-gray-500 leading-relaxed max-w-2xl mx-auto">
            {t.sellergift.hero.description}
          </p>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              {t.sellergift.hero.ctaSecondary}
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {t.sellergift.metrics.map((metric, index) => (
