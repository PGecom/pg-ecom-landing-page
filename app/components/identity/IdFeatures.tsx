...
export default function IdFeatures() {
    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-sm font-semibold text-[var(--primary)] uppercase tracking-wide">{t.identity.features.sectionLabel}</span>
          <h2 className="font-[family-name:var(--font-montserrat)] mt-3 text-3xl sm:text-4xl font-bold text-gray-900">{t.identity.features.heading}</h2>
          <p className="mt-4 text-lg text-gray-500">{t.identity.features.description}</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {t.identity.features.items.map((feature, index) => (
            <div key={index} className="group bg-white rounded-2xl p-6 border border-gray-100 hover:border-indigo-100 hover:shadow-lg hover:shadow-indigo-50 transition-all duration-300">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                {feature.subItems.map((subItem) => (
                  <div key={subItem} className="flex items-center gap-1.5 text-xs text-gray-600">
