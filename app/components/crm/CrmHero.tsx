      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-sm font-medium text-blue-700">{t.crm.hero.badge}</span>
          </div>
          ...
          <h1 className="font-[family-name:var(--font-montserrat)] text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold text-gray-900 leading-[1.1]">
            {t.crm.hero.headingLine1}{" "}
            <span className="gradient-text">{t.crm.hero.headingHighlight}</span>
          </h1>

          <p className="mt-6 text-lg text-gray-500 leading-relaxed max-w-2xl mx-auto">{t.crm.hero.description}</p>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://www.captisso.com/auth/signup" className="w-full sm:w-auto bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white font-semibold px-8 py-3.5 rounded-xl text-base transition-all hover:shadow-lg hover:shadow-indigo-200">
              {t.crm.hero.ctaPrimary}
            </a>
            <a href="https://www.captisso.com/auth/signin" className="w-full sm:w-auto flex items-center justify-center gap-2 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 py-3.5 rounded-xl text-base transition-all">
              {t.crm.hero.ctaSecondary}
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {t.crm.metrics.map((metric, index) => (
