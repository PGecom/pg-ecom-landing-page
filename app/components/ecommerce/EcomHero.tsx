        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-start gap-4">
              <a href="https://store.pgecom.com/auth/seller/register" className="w-full sm:w-auto bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white font-semibold px-8 py-3.5 rounded-xl text-base transition-all hover:shadow-lg hover:shadow-indigo-200">
                {t.ecommerce.hero.ctaPrimary}
              </a>
              <a href="https://store.pgecom.com/auth/seller/login" className="w-full sm:w-auto flex items-center justify-center gap-2 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 py-3.5 rounded-xl text-base transition-all">
