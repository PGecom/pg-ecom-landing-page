...
export default function EcomPricing() {
    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-sm font-semibold text-[var(--primary)] uppercase tracking-wide">{t.ecommerce.pricing.sectionLabel}</span>
          <h2 className="font-[family-name:var(--font-montserrat)] mt-3 text-3xl sm:text-4xl font-bold text-gray-900">{t.ecommerce.pricing.heading}</h2>
          <p className="mt-4 text-lg text-gray-500">{t.ecommerce.pricing.description}</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {t.ecommerce.pricing.tiers.map((tier, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {t.ecommerce.pricing.getStarted}
                </a>
              </div>
            );
          })}
